...
<?php
 ...
 session_start();
 $acct=$_SESSION['no'];
  $query1="SELECT * FROM balance WHERE Account_no='$acct'  AND Against='wifi bill'";
...
<span style="margin-left: 37%;font-size: 20px; color: red;">All the transactions related to  Wifi Payments.<br>
 </span> 
