...
<?php
 ...
 session_start();
 $acct=$_SESSION['no'];
  $query1="SELECT * FROM balance WHERE Account_no='$acct'  AND Against='Electricity_bill'";
...
<span style="margin-left: 37%;font-size: 20px; color: red;">All the transactions related to  Electricity bill Payments.<br>
 </span> 
