...
<i style="font-size: 25px;margin-left: 520px; margin-top: 10px; " class="fa fa-smile-o"> Your Payment Was Sucessful </i>
<div class="footer">
...
<?php
  ...
  // $result1=mysqli_fetch_assoc($run1);
   ...
   echo "<h1 style='margin-top:-5px;margin-left:700px;font-size:25px;'>".$result['debit']." &#x20b9</h1>";
    echo "<h1 style='margin-top:8px;margin-left:700px;font-size:25px;'>".date("d-m-Y")."</h1>";
     echo "<h1 style='margin-top:8px;margin-left:700px;font-size:25px;'>".date("h:i:s a")."</h1>";
?>
