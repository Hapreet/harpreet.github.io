...
<?php
 ...
 session_start();
 $acct=$_SESSION['no'];
  $query1="SELECT * FROM balance WHERE Account_no='$acct'  AND Against='Watersuplly_bill'";
  ...
  {
  	echo "<h1>There is nothing to dsiplay Please check again:";
  }
...
<span style="margin-left: 37%;font-size: 20px; color: red;">All the transactions related to  Water Supply bill Payments.<br>
 </span> 
